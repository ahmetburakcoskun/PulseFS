...
void ImGuiTheme::ApplyPulseFSTheme() {
  ...
  colors[ImGuiCol_PopupBg] = ImVec4(0.12f, 0.12f, 0.15f, 0.94f);
  ...
  colors[ImGuiCol_SliderGrab] = ImVec4(0.35f, 0.65f, 0.85f, 1.00f);
  colors[ImGuiCol_SliderGrabActive] = ImVec4(0.45f, 0.75f, 0.95f, 1.00f);

  colors[ImGuiCol_Button] = ImVec4(0.20f, 0.45f, 0.65f, 1.00f);
  colors[ImGuiCol_ButtonHovered] = ImVec4(0.25f, 0.55f, 0.75f, 1.00f);
  colors[ImGuiCol_ButtonActive] = ImVec4(0.30f, 0.60f, 0.80f, 1.00f);

  colors[ImGuiCol_Header] = ImVec4(0.20f, 0.45f, 0.65f, 0.55f);
  colors[ImGuiCol_HeaderHovered] = ImVec4(0.25f, 0.55f, 0.75f, 0.80f);
  colors[ImGuiCol_HeaderActive] = ImVec4(0.30f, 0.60f, 0.80f, 1.00f);

  colors[ImGuiCol_Separator] = ImVec4(0.20f, 0.20f, 0.25f, 1.00f);
  colors[ImGuiCol_SeparatorHovered] = ImVec4(0.30f, 0.55f, 0.75f, 0.78f);
  colors[ImGuiCol_SeparatorActive] = ImVec4(0.35f, 0.60f, 0.80f, 1.00f);

  colors[ImGuiCol_ResizeGrip] = ImVec4(0.25f, 0.55f, 0.75f, 0.20f);
  colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.60f, 0.80f, 0.67f);
  colors[ImGuiCol_ResizeGripActive] = ImVec4(0.35f, 0.65f, 0.85f, 0.95f);

  colors[ImGuiCol_Tab] = ImVec4(0.15f, 0.35f, 0.55f, 0.86f);
  colors[ImGuiCol_TabHovered] = ImVec4(0.25f, 0.55f, 0.75f, 0.80f);
  colors[ImGuiCol_TabActive] = ImVec4(0.22f, 0.48f, 0.68f, 1.00f);
  colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.22f, 0.35f, 0.97f);
  colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.15f, 0.35f, 0.50f, 1.00f);
  ...
  colors[ImGuiCol_TextSelectedBg] = ImVec4(0.25f, 0.55f, 0.75f, 0.35f);
  colors[ImGuiCol_DragDropTarget] = ImVec4(0.35f, 0.65f, 0.85f, 0.90f);
  colors[ImGuiCol_NavHighlight] = ImVec4(0.35f, 0.65f, 0.85f, 1.00f);
}
